          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
            ...
            <AnimatedSection delay={0.2} className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <h3 className="font-bold text-[#0A1628] mb-4 text-sm">Payment Methods</h3>
                <div className="grid grid-cols-2 gap-2">
                  {["Cash", "Venmo", "Zelle", "Check"].map((method) => (
                ...
                <p className="text-xs text-gray-400 mt-4 leading-relaxed">Payment collected after the job is complete and you&apos;re satisfied.</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    { label: "Re-clean Guarantee", icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" },
